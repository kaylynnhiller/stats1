...
The above is called *dummy coding* or *reference coding* and is by far the most common in sociology. But sometimes (including in the book) you will see *effect coding* (also called *deviation* or *contrast coding*) that codes the predictor (-1, 1) instead of (0, 1).

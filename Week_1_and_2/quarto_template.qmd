...
Quarto allows for [easy cross-references of images and plots](https://quarto.org/docs/authoring/cross-references.html#figures). @fig-dog shows an image, whereas @fig-plot shows a plot created using ggplot2.

![This is a picture of my dogs enjoying the sun outside.](images/IMG_7135.jpeg){#fig-dog fig-align="center"}
...
It's also easy to cross-reference equations. For example, @eq-1 depicts a *normal distribution.*
...
> Hi! My name is Andrés. One of my favorite academic articles is [@advocati]. [@declercq] is a recent article I read. The next thing I plan on reading is this article [@elwyn].
